...
\begin{definition}
The \textbf{prime numbers} are defined as the set of all natural numbers greater than one which are not divisible by any natural number other than one and itself.
\end{definition}
...
\subsection*{The Number of Primes}
\begin{theorem}
